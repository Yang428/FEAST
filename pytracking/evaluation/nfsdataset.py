...
class NFSDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_info):
        ...
        ground_truth_rect = load_text(str(anno_path), delimiter=' ', dtype=np.str)[:,1:5].astype(np.float64)
    ...
    def _get_sequence_info_list(self):
        sequence_info_list = [
            {"name": "Gymnastics", "path": "Gymnastics/30/Gymnastics", "startFrame": 1, "endFrame": 368, "nz": 5, "ext": "jpg", "anno_path": "Gymnastics/30/Gymnastics.txt", "object_class": "person", 'occlusion': False},
