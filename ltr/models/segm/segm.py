...
def segm_resnet50(segm_input_dim=(256,256), segm_inter_dim=(256,256), backbone_pretrained=True, topk_pos=3, topk_neg=3, mixer_channels=2):
    # backbone
    backbone_net = backbones.resnet50_segm(pretrained=backbone_pretrained)
...
@model_constructor
def segm_resnet50_maskInit(segm_input_dim=(256,256), segm_inter_dim=(256,256), backbone_pretrained=True, topk_pos=3, topk_neg=3, mixer_channels=2):
    # backbone
    backbone_net = backbones.resnet50_segm(pretrained=backbone_pretrained)
    ...
    # segmentation
    segm_predictor = segmmodels.SegmNet_maskInit(segm_input_dim=segm_input_dim,
                                            segm_inter_dim=segm_inter_dim,
                                            segm_dim=segm_dim,
                                            topk_pos=topk_pos,
                                            topk_neg=topk_neg,
